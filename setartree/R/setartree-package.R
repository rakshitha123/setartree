#' TODO: Needs to be rewritten for setartree
...
#' Ask your question on Stackoverflow under the tag setartree, or write to the mailing list
#' (setartree@@googlegroups.com). If all that fails, then you can also contact the maintainer 
#' directly by email. 
#' 
#' If you use the package, please cite the following work in your publications:
#'
#' Bergmeir, C. and Benítez, J.M. (2012), Neural Networks in R Using the Stuttgart Neural Network Simulator: setartree. Journal of Statistical Software, 46(7), 1-26. \url{https://www.jstatsoft.org/v46/i07/}
#'
#' The package has a hierarchical architecture with three levels:
#' \itemize{
#' \item setartree high-level api (setartree)
#' \item setartree low-level api (SnnsR)
...
#' all subclasses of \code{\link{setartree}}.
#' 
...
#' \code{\link{$,SnnsR-method}}. R-functions that are added by setartree to the
...
#' visualize and analyse the networks generated with setartree.
#' 
...
# 
# \url{http://sci2s.ugr.es/dicits/software/setartree}
# 
#' A comprehensive report with many examples showing the usage of setartree, 
...
#' @references 
#' 
#' Bergmeir, C. and Benítez, J.M. (2012), 'Neural Networks in R Using the Stuttgart Neural Network Simulator: setartree', Journal of Statistical Software, 46(7), 1-26.
...
#' 
#' @keywords package setartree SETAR forecasting
